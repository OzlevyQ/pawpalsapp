...
const sendMessage = async (req, res) => {
  try {
    ...
    try {
      console.log(`📨 Creating message notifications for chat ${chatId}:`);
      console.log(`Sender: ${req.userId}, Recipients: ${recipients}`);
      ...
      for (const recipientId of recipients) {
        if (recipientId.toString() !== req.userId.toString()) {
          ...
          console.log(`⏭️  Skipping notification for sender: ${recipientId}`);
        }
      }
      console.log('🎉 All message notifications processed');
