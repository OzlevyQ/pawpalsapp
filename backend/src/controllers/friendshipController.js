  ...
  try {
    ...
    if (existingFriendship) {
      ...
      if (existingFriendship.status === 'declined') {
        ...
        console.log(`👥 Creating friend request notification (re-request):`);
        console.log(`   From: ${requesterUser.firstName} ${requesterUser.lastName} (${requesterId})`);
        console.log(`   To: ${recipient.firstName} ${recipient.lastName} (${recipientId})`);
        console.log(`   Friendship ID: ${existingFriendship._id}`);
